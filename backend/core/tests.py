...
class TestCoreSmokeTests(APITestCase):
    ...
    def test_class_monthly_fees_report(self):
        ...
        self.assertEqual(Decimal(row["total_uniform_expected"]), Decimal("300"))
        self.assertEqual(Decimal(row["total_monthly_paid"]), Decimal("50"))
        self.assertEqual(Decimal(row["total_transport_paid"]), Decimal("0"))
        self.assertEqual(Decimal(row["total_uniform_paid"]), Decimal("0"))
        self.assertEqual(Decimal(row["total_expected"]), Decimal("1500"))
        self.assertEqual(Decimal(row["total_paid"]), Decimal("50"))
