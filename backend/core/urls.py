...
urlpatterns = [
    ...
    path(
        "reports/student-payment-list/",
        StudentPaymentListReportView.as_view(),
        name="report-student-payment-list",
    ),
    path(
    ...
    path(
        "reports/expense-statement/",
        ExpenseCategoryStatementReportView.as_view(),
        name="report-expense-statement",
    ),
